...
FUNCTIONS_WORST=(acos acosh acospi asin asinh asinpi atan atan2 atan2f atan2pi atan2pif atanh atanpi cbrt cbrtl cos cosh cospi erf erfc exp expl exp10 exp10m1 exp2 exp2l exp2m1 hypot hypotf hypotl log log10 log10p1 log1p log2 log2l log2p1 pow powf powl rsqrt rsqrtl sin sincos sinh sinpi tan tanh tanpi tgamma)
